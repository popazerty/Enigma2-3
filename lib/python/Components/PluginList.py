...
def PluginEntryComponent(plugin, width=440):
	...
	if screenwidth and screenwidth == 1920:
		return [
			...
			MultiContentEntryText(pos=(180, 35), size=(width-120, 30), font=3, text=plugin.description),
...
def PluginCategoryComponent(name, png, width=440):
	...
	if screenwidth and screenwidth == 1920:
		return [
			name,
			MultiContentEntryText(pos=(110, 10), size=(width-80, 40), font=2, text=name),
...
def PluginDownloadComponent(plugin, name, version=None, width=440):
	...
	if screenwidth and screenwidth == 1920:
		return [
			...
			MultiContentEntryText(pos=(110, 35), size=(width-80, 30), font=3, text=plugin.description),
			MultiContentEntryPixmapAlphaBlend(pos=(10, 0), size=(90, 75), png = png)
		]
	else:
		return [
